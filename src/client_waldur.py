...
# Request method : POST
# Waldur Organization -> http://localhost/api/customers/
# Waldur Project      -> http://localhost/api/projects/
# Waldur Order        -> http://localhost/api/marketplace-offerings/
# Add new members     -> http://localhost/api/user-invitations/
